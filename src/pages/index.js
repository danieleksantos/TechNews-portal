          ...
          {currentPosts.map((post) => (
            ...
            >
              ...
              <Link href={`/posts/${post.id}`}>
                <a className="flex flex-col h-full focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-3xl">
        ...
        {totalPages > 1 && (
          <nav className="flex justify-center items-center gap-6 mb-2" aria-label="Navegação de páginas">
            <button
              ...
              className="px-6 py-2 rounded-full font-bold text-sm uppercase tracking-widest bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 disabled:opacity-30 disabled:cursor-not-allowed hover:border-blue-500 transition-all active:scale-95"
            >
              Anterior
            </button>
